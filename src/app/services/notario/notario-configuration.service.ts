...
export class NotarioConfigurationService {
  ...
  obtenerDatosAdicionales(): Observable<UserAdditionalData> {
    ...
    const endpoint = `${environment.apiUrl}/api/notario/datos-adicionales`;
  ...
  actualizarEmail(nuevoEmail: string): Observable<UpdateResponse> {
    ...
    const endpoint = `${environment.apiUrl}/api/notario/cambioEmail`;
  ...
  actualizarTelefono(nuevoTelefono: string): Observable<UpdateResponse> {
    ...
    const endpoint = `${environment.apiUrl}/api/notario/cambioPhone`;
  ...
  cambiarContrasena(contrasenaActual: string, nuevaContrasena: string): Observable<UpdateResponse> {
    ...
    const endpoint = `${environment.apiUrl}/api/notario/cambiar-contrasena`;
    const body = { 
